...
class RectangularLatticePicker(TargetPicker):
    def __init__(self):
        ...
        self.oversamplingFactor = 10

        self.oversamplingLabel = QtGui.QLabel("Oversampling factor: %d" %self.oversamplingFactor)
...
class TrapControllerInterface(QtWidgets.QWidget):
    ...
    def process_remote_command(self, string):
        target_config = string.strip().split(" ")[0]
